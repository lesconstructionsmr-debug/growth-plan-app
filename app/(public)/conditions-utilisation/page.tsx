  ...
  return (
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '48px 24px 80px' }}>
      ...
      <Section titre="4. Abonnement et facturation">
        <p><strong>4.1 Plans.</strong> Plan Growth est offert en forfaits annuels (engagement de 12 mois) selon le nombre d&apos;utilisateurs avec accès à l&apos;application : {PRICING_TIERS.filter(t => !t.contactOnly).map(t => `${t.name} (${t.usersLabel}, ${formatPriceCad(t.annualTotalCad)} $/an)`).join(' · ')} · {PRICING_TIERS.find(t => t.contactOnly)?.name} (21+ utilisateurs avec accès app, sur devis). Frais d&apos;adhésion unique de {SETUP_FEE_CAD} $ : Plan Growth branche le formulaire du site web, les formulaires Google Ads et les Lead Ads Meta/Instagram au CRM, ainsi que QuickBooks le cas échéant. Les prix s&apos;entendent taxes en sus.</p>
        <p><strong>4.1.1 Définition d&apos;utilisateur.</strong> Un utilisateur est toute personne disposant d&apos;identifiants de connexion à Plan Growth (propriétaire, administrateur ou employé qui pointe). Les contacts inscrits au répertoire de sous-traitants ne constituent pas des utilisateurs facturables, car ils n&apos;ont pas d&apos;accès à l&apos;application.</p>
